		...
		<c:if test="${not empty userProfile}">
			<div class="main-body">
				<div class="col-md-12 mb-5">
					<div class="card-body">
						<div class="d-flex flex-column align-items-center text-center">
							<img src="${userProfile.background}" alt="Background"
								class="img-fluid"
								style="width: 1400px; height: 300px; border-radius: 10px;">
							<img src="${userProfile.avatar}" alt="Avatar"
								class="rounded-circle" width="150"
								style="position: absolute; top: 20%; left: 50%; transform: translate(-320%, 50%); z-index: 1;">
							<div class="mt-3 mb-5"
								style="position: absolute; top: 75%; left: 300px; transform: translateY(-50%); text-align: left; color: black;">
				...
				<div class="col-md-8 mb-5" style="padding-top: 55px;">
					...
					<div class="row">
						<div class="col-sm-12">
							<a class="btn btn-info " target="__blank">Chỉnh sửa thông tin
								cá nhân</a>
						</div>
					</div>
				</div>
